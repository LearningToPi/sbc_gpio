...
class devtesterTest(unittest.TestCase):
    def test_1_ir_test(self):
        ...
        dev_tester.start(run_secs=10, wait=True)
        logger.info(f'{dev_tester.test_results}')
        self.assertTrue(dev_tester.test_results.passed)
    ...
    def test_4_dht(self):
        ...
        dht_tester = DevTest_DHT(int(test_vars.get('dht_spi', 0)), pin, log_level=INFO, dht22=True)
        logger.info('----------------- Test 10 iterations blocking')
    ...
    def test_7_threading(self):
        ...
        i2c_tester = DevTest_I2CDisp(7, log_level=INFO)
        ...
        self.assertTrue(bmx_tester.test_results.passed and dht_tester.test_results.passed and btn_tester.test_results.passed and led_tester.test_results.passed and ir_tester.test_results.passed and i2c_tester.test_results.passed)
